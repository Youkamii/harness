...
const SCENARIOS = [
  ...
  ['새 터미널 창을 띄우려 할 때', /터미널 창 금지|콘솔 창.*띄우지 않는다/s, '창 금지 — 현재 세션에서 실행'],
  ['사용자가 보안을 문제 삼지 말라고 했을 때', /문제 삼지 말라.*(지적을 반복|막지 않는다)/s, '지적 반복·차단 금지'],
  ['꼭 필요한 보안 조치를 발견했을 때', /말없이 넣지도.*말없이 빼지도.*먼저 질문/s, '몰래 넣지 말고 예시와 함께 질문'],
];
